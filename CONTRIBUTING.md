# Contributing to weicore-lib

We're working hard to make _weicore-lib_ the most powerful JavaScript library for working with Wei. Our goal is to have _weicore-lib_ be a library that can be used by anyone interested in Wei, and to level expertise differences with great design and documentation.

## Community

If there are any questions, etc., please feel to ask in one of the community channels:

- https://www.weicrypto.com/forum (Support Forum)
...
These are some global design goals in weicore-lib that any change must adhere.
...
When possible, weicore-lib objects should have standard methods on an instance prototype:
...
`JSON.stringify` and `JSON.parse` are expected to be handled outside of the scope of weicore-lib methods. For example, calling `JSON.stringify` on an weicore-lib object will behave as expected and call `transaction.toJSON()` and then stringify it:
...
#### T3 - Require 'weicore' and Look up Classes from There

This helps to make tests more useful as examples, and more independent of where they are placed. This also helps prevent forgetting to include all submodules in the weicore object.

DO:

```javascript
var weicore = require('../');
var PublicKey = weicore.PublicKey;
```
...
```sh
git remote add weicrypto git@github.com:weicrypto/weicore-lib.git
git pull --rebase weicrypto master
```
...
Finally go to [github.com/weicrypto/weicore-lib](https://github.com/weicrypto/weicore-lib) in your web browser and issue a new pull request.

Main contributors will review your code and possibly ask for changes before your code is pulled in to the main repository. We'll check that all tests pass, review the coding style, and check for general code correctness. If everything is OK, we'll merge your pull request and your code will be part of weicore-lib.

If you have any questions feel free to post them to
[github.com/weicrypto/weicore-lib/issues](https://github.com/weicrypto/weicore-lib/issues).
